# Test Size Analysis for Unstructured Covariance Martix Based Data When Mean Changes
# Variable Y01 (mean = -0.223, sd = 0.10)
...
source("/home/khasan/BKMR/r_code/testSizeAnalysisMean_20240220/unstrucTestSizeAnalysisMean_20230220.R")
...
# Save results
output_dir <- "data/unstrucTestSizeAnalysisMean_20240220"
...
saveRDS(
  analysisResults,
  file = file.path(output_dir, "unstrucTestSizeMeanY01.rds")
)
