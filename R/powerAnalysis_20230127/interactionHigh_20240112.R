# BKMR Power Analysis of Interaction High
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "interactionHigh_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here("data", "powerBKMR_20240127", "interactionHigh_20240127.rds")
)
