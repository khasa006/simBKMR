# BKMR Power Analysis of Full Factorial Low
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "fullFactorialLow2_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here(
    "data", "powerBKMR_20240127", "fullFactorialLow_20240127.rds"
  )
)
