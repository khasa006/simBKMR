# BKMR Power Analysis of Normal High
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "normalHigh3_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here("data", "powerBKMR_20240127", "normalHigh_20240127.rds")
)
