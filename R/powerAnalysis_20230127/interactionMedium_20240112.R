# BKMR Power Analysis of Interaction Medium
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "interactionMedium_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here(
    "data", "powerBKMR_20240127", "interactionMedium_20240127.rds"
  )
)
