# BKMR Power Analysis of Interaction Low
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "interactionLow_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here("data", "powerBKMR_20240127", "interactionLow_20240127.rds")
)
