# BKMR Power Analysis of Normal Medium
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "normalMedium3_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here("data", "powerBKMR_20240127", "normalMedium_20240127.rds")
)
