# BKMR Power Analysis of Skewed High
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "skewedHigh_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here("data", "powerBKMR_20240127", "skewedHigh_20240127.rds")
)