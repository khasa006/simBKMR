# BKMR Power Analysis of Skewed Low
...
# saveRDS(
#   analysis_results,
#   file =  here::here("data", "powerBKMR_20240112", "skewedLow_20240112.rds")
# )
...
saveRDS(
  analysis_results,
  file =  here::here("data", "powerBKMR_20240127", "skewedLow_20240127.rds")
)
