...
param_list <- read_rds("./data/param_list_20230605.rds")
...
cor_list <- read_rds("./data/cor_list_20240111.rds")
...
for (i in 1:num_samples) {
  ...
  #   as.matrix()
  corr_female <- diag(13) # cor_list$Female
