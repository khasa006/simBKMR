...
source("/home/khasan/BKMR/r_code/testSizeAnalysisVar_20240220/testSizeAnalysisVar_20240220.R")
...
# Save results
output_dir <- "/home/khasan/BKMR/data/diagTestSizeAnalysisVar_20240220"
...
saveRDS(
  analysisResults,
  file = file.path(output_dir, "diagtestSizeVarY03.rds")
)