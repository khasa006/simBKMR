# Test Size Analysis for Unstructured Covariance Martix Based Data
# Variable Y01 (mean = -1.0, sd = 0.10)
...
source("/home/khasan/BKMR/r_code/testSizeAnalysisVar_20240220/unstucTestSizeAnalysisVar_20240225.R")
...
# Save results
output_dir <- "/home/khasan/BKMR/data/unstrucTestSizeAnalysisVar_20240220"
...
saveRDS(
  analysisResults,
  file = file.path(output_dir, "unstrucTestSizeVarY01.rds")
)